    ...
    for(let i = 0; i < items.length; i++) {
        items[i].addEventListener('click', () => {
            ...
            let htmlEle = `<div id="information">
                                ...
                                <h3>Phân bố</h3>
                                <h4>Trong nước:</h4><p>${search_page_list[i].incountry}</p>
                                <h4>Thế giới:</h4><p>${search_page_list[i].onWorld}</p>
    ...
    for(let i = 0; i < items.length; i++) {
        items[i].addEventListener('click', () => {
            ...
            let htmlEle = `<div id="information">
                                ...
                                <h3>Phân bố</h3>
                                <h4>Trong nước:</h4><p>${pageList[i].incountry}</p>
                                <h4>Thế giới:</h4><p>${pageList[i].onWorld}</p>
